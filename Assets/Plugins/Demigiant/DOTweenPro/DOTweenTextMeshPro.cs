...
namespace DG.Tweening
{
    ...
    public static class ShortcutExtensionsTMPText
    {
        ...
        public static TweenerCore<double, double, NoOptions> DODoubleCounter(
             this TMP_Text target, double fromValue, double endValue, float duration, bool addThousandsSeparator = true, CultureInfo culture = null
)
        {
            double v = fromValue;
            CultureInfo cInfo = !addThousandsSeparator ? null : culture ?? CultureInfo.InvariantCulture;
